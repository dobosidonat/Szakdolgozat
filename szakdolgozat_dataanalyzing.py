...
plt.title('Az Lens elmúlt 3 évben elért bajnoki helyezései', fontsize=14)
...
plt.title('Az Union Berlin elmúlt 4 évben elért bajnoki helyezései', fontsize=14)
plt.xlabel('Szezon', fontsize=12)
plt.ylabel('Helyezés', fontsize=12)
plt.legend()
plt.show()
...
"""######**ÖSSZEGZÉS**
6 vizsgált játékos húzóembere volt az évek alatt a Arsenal támadójátékának, és mindegyik játékos teljesítménye növekvő tendenciát mutat ezáltal kijelenthető, hogy az Arsenal sikerrességének kulcsa a 2022-2023-as szezonban támadójátékának minőségében rejlett.
